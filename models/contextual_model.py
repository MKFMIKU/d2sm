...
class ContextualModel(BaseModel):
    ...
    def __init__(self, args):
        ...
        self.vgg = contextual.VGG(type="contextual")
    ...
    def optimize_parameters(self):
        ...
        contextual_loss = self.vgg(self.sr, self.hr)
        self.contextual_loss = l1_loss + contextual_loss
        self.optimizer.zero_grad()
        self.content_loss.backward()
        self.optimizer.step()
        return self.contextual_loss, self.sr.size(0)
